...
export interface Mutation {
  SendChatMessages: SendChatMessagesResponse;
...
export interface SendChatMessagesMutationArgs {
  chatId: number;
  text: string;
}
...
export interface SendChatMessagesResponse {
  ok: boolean;
  error: string | null;
